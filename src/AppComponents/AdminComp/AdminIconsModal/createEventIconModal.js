...
export default function CreateEventIconModal(props) {
    ...
    return (
        <MDBModal isOpen={props.constName} toggle={props.functionName}  centered size="lg">
            <MDBModalBody>
                <h6 className="mt-2"><strong>Create Event</strong></h6>
                <hr/>
                <div className="row">
                            ...
                            <div className="col-md-8 offset-md-2 text-center">
                                <input type="file" id="file" style={{display: "none"}}
                                    ...
                                    <label htmlFor="file" style={imageFileStyle}>
                                                        Upload event header image <span className='fa fa-download' style={{backgroundColor:'#39729b', color:'#ffffff', padding:'5px', borderRadius:'10px'}}> </span>
                                    </label>
                                </div>
                            </div>
                     </div>
                    ...
                    <div className="col-md-6">
                        <div className="row mt-2">
                            <div className="col-6 col-md-5">
                                <img src="/images/others/stadtstrandFeature1.jpeg" 
                                    alt="eventImage1"
                                    style={{border:'1px solid #39729b',height:'80px', width:'120px',borderRadius:'15px'}} />
                            </div>
                            <div className="col-6 col-md-5 offset-md-2">
                                <img src="/images/others/stadtstrandFeature3.jpeg" 
                                    alt="eventImage1"
                                    style={{border:'1px solid #39729b',height:'80px', width:'120px',borderRadius:'15px'}} />
                            </div>
                        </div>
                    ...
                    <div className="col-md-6">
                        <div className='custom-control custom-switch mt-2'>
                            <input
                                ...
                                id='eventCountSwitch'
                            />
                            <label className='custom-control-label' htmlFor='eventCountSwitch'>
