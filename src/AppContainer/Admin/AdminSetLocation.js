...
function AdminSetLocation (props) {
  ...
  const createLocation = (e) => {
    ...
    Axios.post("https://api.cloudinary.com/v1_1/ecrtechdev/image/upload",data,{
      headers: {
    ...
    .then((response) => {
      ...
      Axios.post('https://stadstrandnodeapi.herokuapp.com/api/v1/brandpage',  {
      name: locationName,
                        ...
                        <form onSubmit={createLocation}>
                              ...
                              <div className="col-md-8 offset-md-2">
                                <input type="file" id="file" style={{display: "none"}} 
                                  ...
                                  <label htmlFor="file" style={imageFileStyle}>
                                      ...
                                      style={
                                        { backgroundColor:'#39729b', color:'#ffffff', 
...

                            {
                                ...
                                <div className="col-md-10 offset-md-1 text-center">
                                    <img src={imagePreview} alt="img preview" id={AdminStyle.imgBoxed} />
                                </div>
                                </div> : <div></div>
                            }
