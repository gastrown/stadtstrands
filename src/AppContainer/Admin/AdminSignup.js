...
function AdminSignup () {
  ...
  const onSubmitReg = (e) => {
    ...
    Axios.post('https://stadstrandnodeapi.herokuapp.com/api/v1/admin',  {
      name: name,
      email: email,
      username: username,
      password: password
                ...
                <form onSubmit={onSubmitReg}>
                    <div className="row">
                        <div className="col-10 offset-1">
                            {modalSuccess ? <MDBAlert color="success">
                              Redirecting to login page.... <div className="spinner-grow text-success fast ml-2" role="status">
