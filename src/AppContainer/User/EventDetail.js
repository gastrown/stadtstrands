...
import { 
    MDBContainer,MDBIcon,MDBCarousel, MDBCarouselInner, MDBCarouselItem, MDBView
  } from 'mdbreact';
...
export default function EventDetail(props) {
    //console.log(props.location.state.eventDetails);
                ...
                <div className="col-10 offset-1 col-md-5 offset-md-3 mt-3 mb-5" id={UserStyles.listCard}>
                    ...
                    <div className="row">
                        <div className="col-10 offset-1">
                                        {/* <img
                                                className="img-fluid"
                                                src={singleJobDetail.eventImg[0].eventImgpath}
                                                alt={singleJobDetail.eventTitle}
                                                style={{borderRadius:'10px'}}
                                            /> */}
                            <MDBCarousel
                                activeItem={1}
                                length={singleJobDetail.eventImg.length}
                                showControls={true}
                            ...
                            >
                                <MDBCarouselInner>
                                    {
                                        singleJobDetail.eventImg.map( eventSlideImg => {
                                            return(
                                                <MDBCarouselItem itemId={eventSlideImg.id} key={eventSlideImg.id}>
                                                    <MDBView>
                                                    <img
                                                        className="d-block w-100"
                                                        src={eventSlideImg.eventImgpath}
                        ...
                        <div className="col-10 offset-1 mt-4 mt-3 font-small text-left">
                            <div className="row">
                                <div className="col-12">
                                    <div>
                                        ...
                                        <h5 style={{fontWeight:'500'}}>{singleJobDetail.eventTitle}</h5>
                                    </div>
                                    <hr/>
                                    <div className="row">
                                        <div className="col-7" >
                                            ...
                                            }>{convertedDate(singleJobDetail.eventDate)} 
                                            <MDBIcon far icon="calendar-alt" style={{marginLeft:'10px'}} /> </span> <br/>
                                        </div>
                                        ...
                                        <div className="col-5" >
                                            ...
                                            }>{convertedTime(singleJobDetail.eventDate)} 
                                            <MDBIcon far icon="clock" style={{marginLeft:'10px'}}/> </span> <br/>
                                        </div>
                                        
                                    </div>
                                    <p className="mt-4">
                                        <span className="mr-2" style={{fontSize:'12px'}}><MDBIcon icon="map-marker-alt" /></span>
                                        <span style={{fontSize:'14px'}}>{singleJobDetail.eventLocation}</span> <br/>
                                    </p>
                                </div>          
                            </div>
                            <div className="row mt-2 mb-2">
                                ...
                                <span style={{fontSize:'12px', fontWeight:'300',color:'#020202'}} className="mt-4">
                                    {singleJobDetail.eventDescription}
                                </span>
                                </div>
                            </div>
                        </div>
