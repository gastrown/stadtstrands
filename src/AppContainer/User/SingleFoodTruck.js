...
export default function SingleFoodTruck(props) {
    ...
    const aboutDetails = {
            ...
            SubSession: [
                {
                    id:'1',
                    aboutTitle:'ABOUT CITY BEACH TRUCK 1',
                    aboutDescription:`
                ...
                <div className="col-10 offset-1 col-md-6 offset-md-3 mt-3 mb-5" id={UserStyles.listCard}>
                    ...
                    <div className="row">
                        <div className="col-10 offset-1 text-left"  style={
                            { 
                                backgroundImage:`url(/images/others/truck2.jpg)`,
                    ...
                    <div className="row">
                        <div className="col-10 offset-1 mt-3 font-small text-left ">
                            ...
                            <span style={{fontSize:'12px', fontWeight:'500'}} className="mt-4">AROUND THE WORLD WITH FOODTRUCKS</span>
                            ...
                            <p>Always something new to eat</p>
                        </div>
                    </div>
